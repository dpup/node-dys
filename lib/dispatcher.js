 ...
 * @private
 */
Dispatcher.prototype.credentials_;
...
/**
 * Sets the secure credentials to use when creating a HTTP server, options
 * object is passed to https.createServer.
 * @param {Object} credentials Object with key and cert fields.
 */
Dispatcher.prototype.setCredentials = function(credentials) {
 ...
 * @param {Object=} opt_credentials Optional credentials to use if the server
 *     should use HTTPS.
 */
